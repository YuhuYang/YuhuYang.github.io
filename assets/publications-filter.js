  ...
  const papers = [
    {
      ...
      authors: { zh: ['杨牧', '刘海涛'], en: ['Yang Mu', 'Haitao Liu'] },
    ...
    },
    {
      ...
      authors: {
        zh: ['Tsy Yih', 'Yiran Yang', 'Yang Mu', 'Haitao Liu', 'Lihe Huang'],
        en: ['Tsy Yih', 'Yiran Yang', 'Yang Mu', 'Haitao Liu', 'Lihe Huang'],
      },
    ...
    },
    {
      ...
      authors: { zh: ['杨苛鑫', '庄会彬', '杨牧'], en: ['Kexin Yang', 'Huibin Zhuang', 'Yang Mu'] },
    ...
    },
    {
      ...
      authors: { zh: ['杨牧', '蔡言胜'], en: ['Yang Mu', 'Cai Yansheng'] },
