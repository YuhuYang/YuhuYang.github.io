(() => {
  const dictionary = {
    ...
    about_edu_1: { zh: '2016-2020：山东大学 翻译学院 文学学士', en: '2016-2020: B.A., School of Translation, Shandong University' },
    about_edu_2: { zh: '2020-2023：南开大学 汉语言文学学院 文学硕士', en: '2020-2023: M.A., College of Chinese Language and Literature, Nankai University' },
    ...
    conf_2025_7: { zh: '2025年：山东大学（威海）翻译学院暑期计量语言学培训班 8 小时报告（山东威海，山东大学）', en: '2025: 8-Hour Lecture at the Summer Quantitative Linguistics Training Program, School of Translation, Shandong University (Weihai, Shandong University)' },
