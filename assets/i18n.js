(() => {
  const dictionary = {
    ...
    software_title: { zh: '句法计量软件：QuanSyn', en: 'Quantitative Syntax Software: QuanSyn' },
    software_intro: { zh: 'QuanSyn 是面向句法计量分析的工具体系，提供适合批量研究流程的 Python package，以及适合交互式探索、教学和展示的 QuanSyn Studio。', en: 'QuanSyn is a toolkit for quantitative syntax analysis, offering a Python package for batch research workflows and QuanSyn Studio for interactive exploration, teaching, and demonstrations.' },
    software_python_label: { zh: '面向代码与批量分析', en: 'For code and batch analysis' },
    software_python_title: { zh: 'QuanSyn Python Package', en: 'QuanSyn Python Package' },
    software_python_desc: { zh: '适合 Python 用户、批量语料处理、可复现实验和论文分析流程，可直接集成到研究脚本中。', en: 'Designed for Python users, batch corpus processing, reproducible experiments, and paper-oriented analysis workflows that can be integrated into research scripts.' },
    software_python_feature_1: { zh: '句法计量指标计算', en: 'Quantitative syntax metrics' },
    software_python_feature_2: { zh: '依存句法数据处理', en: 'Dependency syntax data processing' },
    software_python_feature_3: { zh: '语言网络边抽取', en: 'Linguistic network edge extraction' },
    software_python_feature_4: { zh: 'Treebank / CoNLL-U 分析', en: 'Treebank / CoNLL-U analysis' },
    software_python_users: { zh: '推荐给会 Python、需要批处理或希望将 QuanSyn 接入研究管线的用户。', en: 'Recommended for users who know Python, need batch processing, or want to connect QuanSyn to a research pipeline.' },
    software_python_pypi_btn: { zh: '查看 PyPI', en: 'View PyPI' },
    software_studio_label: { zh: '面向图形化与交互探索', en: 'For graphical and interactive exploration' },
    software_studio_title: { zh: 'QuanSyn Studio', en: 'QuanSyn Studio' },
    software_studio_desc: { zh: '图形化应用界面，适合不想写代码或需要交互式分析、课堂演示和探索式研究的用户。', en: 'A graphical application interface for users who prefer not to code or need interactive analysis, classroom demonstrations, and exploratory research.' },
    software_studio_feature_1: { zh: '句法指标计算', en: 'Syntax metric calculation' },
    software_studio_feature_2: { zh: '句法分析', en: 'Syntactic analysis' },
    software_studio_feature_3: { zh: '句法树编辑与可视化', en: 'Syntactic tree editing and visualization' },
    software_studio_feature_4: { zh: '网络分析与可视化', en: 'Network analysis and visualization' },
    software_studio_feature_5: { zh: '结果导出', en: 'Result export' },
    software_studio_users: { zh: '推荐给语言学研究者、课程教学、演示和探索式分析用户。', en: 'Recommended for linguistics researchers, teaching, demonstrations, and exploratory analysis.' },
    software_studio_download_btn: { zh: '下载 Studio', en: 'Download Studio' },
    software_resources_title: { zh: '资源与下载', en: 'Resources and Downloads' },
    software_resources_desc: { zh: 'Python package 适合可复现的代码流程；QuanSyn Studio 适合交互式分析。源码、README 与发布版本均可从 GitHub 获取。', en: 'The Python package supports reproducible code workflows; QuanSyn Studio supports interactive analysis. Source code, README, and releases are available on GitHub.' },
    software_github_btn: { zh: '打开 GitHub', en: 'Open GitHub' },
    software_readme_link: { zh: '查看 README', en: 'View README' },
    software_download_btn: { zh: '前往 Releases', en: 'Open Releases' },
    software_mini_note: { zh: 'quansyn mini 是早期简洁界面版本，当前页面主要介绍 Python package 与 QuanSyn Studio。', en: 'quansyn mini is an earlier lightweight interface; this page focuses on the Python package and QuanSyn Studio.' },
    ...
    software_used_title: { zh: '使用 QuanSyn 的研究', en: 'Studies Using QuanSyn' },
